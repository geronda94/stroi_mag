...
;
    ...
    INSERT INTO delivery_price(name,  price, max_weight, comission,  order_num) VALUES
    ('Самовывоз','0', '9999999','0','1'),
    ('Тирасполь до 3х тон','150','3000','20','2'),
    ('Суклея  до 3х тон', '180','3000','20','3'),
    ('Кицканы до 3х тон', '300','3000','20','4'),
    ('Манипулятор по Тирасполю до 5 тон', '500','5000','20','5'),
    ('ЗИЛ по Тирасполю до 6 тон', '300','6000','20','6')
    ;